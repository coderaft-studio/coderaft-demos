...
export default function BentoPage() {
  ...
  return (
    <>
      ...
      {/* ── BENTO HERO ── */}
      <section className="pt-20 pb-4 px-4 sm:px-6 max-w-6xl mx-auto">

        {/* Row 1: Headline + Stats + CTA */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-3">
          {/* Headline card — dark */}
          <div className="col-span-1 sm:col-span-2 rounded-3xl p-8 sm:p-10 relative overflow-hidden flex flex-col justify-between" style={{ background: "#0a0a0a", minHeight: "300px" }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 mb-3">
          <div className="col-span-1 sm:col-span-3 rounded-3xl px-6 sm:px-8 py-4 flex items-center overflow-x-auto" style={{ background: "#f0f0f5", border: "1px solid rgba(0,0,0,0.07)" }}>
            <span className="text-xs font-black mr-6 sm:mr-8 flex-shrink-0 tracking-widest" style={{ color: "rgba(10,10,10,0.5)" }}>TRUSTED BY</span>
      ...
      <section id="services" className="py-16 sm:py-20 px-4 sm:px-6 max-w-6xl mx-auto">
        <div className="flex flex-wrap items-end justify-between gap-4 mb-10">
          <div>
            ...
            <h2 className="font-black text-3xl sm:text-4xl text-slate-900">What we do</h2>
          </div>
        ...
        <div style={{ border: "2px solid rgba(10,10,10,0.1)", borderRadius: "24px", overflow: "hidden" }}>
          {services.map((s, i) => (
            <div key={s.no} className="flex items-center gap-4 sm:gap-8 px-4 sm:px-8 py-5 sm:py-7 group hover:bg-indigo-50 transition-colors cursor-pointer"
              ...
              <div className="flex-1 min-w-0">
                <div className="font-black text-base sm:text-xl text-slate-900 group-hover:text-indigo-600 transition-colors">{s.title}</div>
      ...
      {/* ── ABOUT BENTO ── */}
      <section id="about" className="pb-4 px-4 sm:px-6 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="col-span-1 sm:col-span-2 rounded-3xl p-8 sm:p-10" style={{ background: "#4338ca" }}>
            <p className="text-xs font-black tracking-widest mb-6" style={{ color: "rgba(255,255,255,0.6)", letterSpacing: "0.2em" }}>ABOUT FORMA</p>
            <h2 className="font-black text-3xl sm:text-4xl text-white leading-tight mb-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-1 grid-rows-1 sm:grid-rows-2 gap-3">
      ...
      <section id="contact" className="py-16 sm:py-20 px-4 sm:px-6 max-w-6xl mx-auto">
        <div className="rounded-3xl p-6 sm:p-12" style={{ background: "#0a0a0a" }}>
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <div>
              ...
              <h2 className="font-black text-3xl sm:text-4xl text-white mb-4 leading-tight">
      ...
      {/* Footer */}
      <footer className="px-4 sm:px-6 pb-10 max-w-6xl mx-auto">
        <div className="flex flex-wrap justify-between items-center gap-2 pt-6" style={{ borderTop: "2px solid rgba(10,10,10,0.08)" }}>
