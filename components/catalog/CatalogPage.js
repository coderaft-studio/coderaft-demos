      ...
      <header style={{ position: "sticky", top: 0, zIndex: 50, background: "rgba(7,7,17,0.88)", backdropFilter: "blur(20px)", borderBottom: "1px solid rgba(139,92,246,0.12)" }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6" style={{ height: "64px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            <svg width="30" height="30" viewBox="0 0 100 100" fill="none"><defs><linearGradient id="dg1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#8b5cf6"/><stop offset="100%" stopColor="#a78bfa"/></linearGradient><linearGradient id="dg2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#a78bfa"/><stop offset="100%" stopColor="#ec4899"/></linearGradient></defs><path d="M50 14 L50 60 L20 60 Z" fill="url(#dg1)"/><path d="M50 22 L50 60 L70 60 Z" fill="url(#dg2)" opacity="0.85"/><path d="M16 64 Q50 76 84 64 L79 71 Q50 83 21 71 Z" fill="url(#dg1)"/><path d="M10 82 Q20 77 30 82 Q40 87 50 82 Q60 77 70 82 Q80 87 90 82" stroke="url(#dg1)" strokeWidth="3.5" fill="none" strokeLinecap="round"/><path d="M20 92 Q32 87 44 92 Q56 97 68 92 Q76 88 82 92" stroke="url(#dg2)" strokeWidth="2.5" fill="none" strokeLinecap="round" opacity="0.55"/></svg>
