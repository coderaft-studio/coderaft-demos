...
const photos = [
  { src: "/demo/wedding/hero.jpg", alt: "Pernikahan Garden", span: "lg:col-span-2 lg:row-span-2" },
  ...
  { src: "/demo/wedding/galeri6.jpg", alt: "Resepsi Outdoor", span: "lg:col-span-2" },
];
  ...
  return (
    <section id="galeri" className="py-24 bg-rose-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" style={{ gridAutoRows: "220px" }}>
          {photos.map(p => (
